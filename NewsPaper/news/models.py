...
# User.add_to_class('rating', models.IntegerField())
...
class Author(models.Model):
    ...
    #     self.rate = self.get_author_posts_rate() + self.get_comments_to_author_posts_rate() + self.get_comments_to_author_posts_rate()
    #     self.save()
